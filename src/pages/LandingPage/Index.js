    ...
    <div className="w-full bg-gray-300 text-primary flex flex-col items-center">
      <div className=" flex gap-10 sw justify-around items-center my-10 flex-wrap">
        <div className="flex-1 min-w-[300px] md:max-w-[300px] flex flex-col gap-4 items-start">
          <h3 className="font-['Helvetica_Bold']">Who am I?</h3>
          <p className="font-bold">Tommy is self taught Ad creator, web designer and video editor based out of Hawassa.</p>
  ...
  return (
    <div className="grad-diag w-full flex flex-col items-center">
      <div className="flex flex-col gap-20 sw p-10 justify-center min-h-[70vh] h-[calc(100vh-75px)]">
        <div>
          <h1 className="!text-[82px] bolder uppercase">I Bring Ideas To Life.</h1>
        </div>
        ...
        <div className="flex justify-between items-center flex-wrap gap-10 px-10">
          ...
          <a href="/#" className="btn_sty1 py-3 flex gap-3 items-center italic uppercase">Browse Work <Play width={14} /></a>
        </div>
      </div>
    </div>
  )
